...
public class Ex0505_GawiBawiBo {
	...
	public static int playGame() throws IOException
	{
		...
		return playGame(x, y, z); //...method overloading.		
	...
	private static int playGame(int x, int y, int z) throws IOException
	{
		...
		do{
			...
			do{
				...
				System.out.println("1st Digits : ");
				user = in.readLine();
				usr[0] = new Integer(user).intValue();
				
				System.out.println("2nd Digits : ");
				user = in.readLine();
				usr[1] = new Integer(user).intValue();
				
				System.out.println("3rd Digits : ");
				user = in.readLine();
			...
			}while((usr[0]==0)||(usr[1]==0)||(usr[2]==0)|| //...0 is not allowed.
		             (usr[0]>9)||(usr[1]>9)||(usr[2]>9)|| //...1~9 is allowed.
