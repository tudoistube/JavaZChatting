...
public class Ch1_10_WriteToFileEvent  extends Frame implements ActionListener
{
	   Label lfile, ldata;
	   ...
	   public Ch1_10_WriteToFileEvent(String str){
	      super(str);
	   ...
	   public static void main(String args[]){
		   Ch1_10_WriteToFileEvent text = new Ch1_10_WriteToFileEvent("파일저장");
